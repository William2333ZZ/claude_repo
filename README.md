...
本仓库包含：`datafoundry/` 平台代码(v0.2,140 例测试全绿)+ `skills/` 技能包四件套(装进你的 harness 即用,含注册登录剧本)+ `docs/` 产品文档集。

**架构从这里读:[docs/25 · 架构总纲](docs/25-架构总纲.md)**(一文全貌,含图与文档地图)。
